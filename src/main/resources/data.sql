...
--SCENARIO je me retire de la file d'attente mais je m'y remet !
INSERT INTO utilisateurs (desactive, email, mot_de_passe_chiffre, nom, prenom, role)
VALUES (false, 'mariecurry@polonium.com', '$2a$10$26.ezViBvLzeEl1XK5v9L.EUtJ4ApAsYdvNLf7WUjF4QmZuO0rak.', 'Curie', 'Marie', 'UTILISATEUR');

INSERT INTO livres (date_de_parution, id_etat, isbn, titre, url_image, synopsis)
VALUES ('2016-11-06', 2, '9782253087304', 'Mémé dans les orties',
        'https://www.babelio.com/couv/CVT_Meme-dans-les-orties_2968.jpg',
        'Ferdinand Brun, 83 ans, solitaire, bougon, acariâtre - certains diraient : seul, aigri, méchant -, s''ennuie à ne pas mourir. Son unique passe-temps ? Éviter une armada de voisines aux cheveux couleur pêche, lavande ou abricot. ');

INSERT INTO auteurs (nom, prenom) VALUES ('VALOGNES', 'Aurélie');
INSERT INTO livres_genres VALUES (9, 16);
INSERT INTO livres_auteurs VALUES (21, 16);

insert into reservations (date_disponibilite, date_retrait_max, est_supprimee, rang, date_demande_reservation,
                          id_livre, id_statut, id_utilisateur)
values ((CURRENT_DATE - INTERVAL '10 days'), (CURRENT_DATE + interval '4 days'), false, 1,
        (CURRENT_DATE - INTERVAL '3 Days'), 16, 2, 1);

insert into reservations (date_disponibilite, date_retrait_max, est_supprimee, rang, date_demande_reservation,
                          id_livre, id_statut, id_utilisateur)
values ((CURRENT_DATE - INTERVAL '10 days'), (CURRENT_DATE + interval '4 days'), false, 2,
        (CURRENT_DATE - INTERVAL '3 Days'), 16, 1, 9);
